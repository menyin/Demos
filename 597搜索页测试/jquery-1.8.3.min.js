    ...
    function checkDefinedLoaded(moduleName){
        ...
        if(status){
            if(factory = cache[ moduleType.module + moduleName ].factory){
                ...
                var args = factory.length <= 1 ? [cache[ moduleType.define + moduleName ]] : [package['#provide:require'],cache[ moduleType.exports + moduleName ],cache[ moduleType.define + moduleName ]];
...
jpjs.config({
    ...
    combos: {
        ...
        '@search': [
            ...
            'widge.autoComplete.search', 'widge.autoComplete.filter','product.jpCommon'
        ],
        '@receiveMailDialog': [
